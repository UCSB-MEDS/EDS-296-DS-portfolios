...
- Include info about the software / produce to users, developers, and / or contributors
...
GitHub makes this easy! Check the "Add a README file" box each time to create a repo on GitHub:
...
Open and close a code block with three backticks. Use the pipe, `|`, along with these (somewhat odd) characters, `├──` & `└──`, to construct a folder / file map of your repo.
:::
...
::: {.center-text .teal-text .body-text-xl}
Add any important information regarding your data source(s), then share with your neighbor.
:::
