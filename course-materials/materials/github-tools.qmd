...
Code is oftentimes spread across **multiple repositories** (capstone & GPs are an excellent example of this!) -- projects can be particularly **helpful for tracking TODOs and progress across them.**
...
[You can host **one** website or rendered HTML document from any GitHub repository.]{.body-text-m}
...
- same process as hosting your personal website (see [week 0 materials](https://ucsb-meds.github.io/creating-quarto-websites/#github-pages)) 
  - [**NOTE:** you're only allowed **one** user website with the `github.io` suffix, e.g. `<username>.github.io` -- all other URLs will be structured as `<username>.github.io/<nameOfRepo>`)]{.body-text-s}
